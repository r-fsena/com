...
export function MessageTemplatesModal({
    ...
    <div className="flex flex-col h-full bg-white rounded-3xl overflow-hidden shadow-2xl border border-slate-200">
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-slate-50/50">
        {isCreatingNew ? (
          ...
          /* ======================================================== */
          <form onSubmit={handleSaveForm} className="max-w-2xl mx-auto bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 text-xs rounded-xl px-3 py-2.5 border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#3742AC]/20 focus:border-[#3742AC] transition"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 text-xs font-mono font-bold text-[#3742AC] rounded-xl px-3 py-2.5 border border-slate-200 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#3742AC]/20 focus:border-[#3742AC] transition"
                />
              </div>
            </div>
            ...
            <div className="space-y-2 bg-slate-50 p-4 rounded-xl border border-slate-200/80">
              <div className="flex items-center justify-between">
                <label className="text-xs font-bold text-slate-700 flex items-center gap-1.5">
                  ...
                  <span>Imagem / Anexo do Modelo (Opcional)</span>
                </label>
                {formImageUrl && (
                  <button
                    type="button"
              ...
              <div className="flex flex-col sm:flex-row items-start gap-3">
                {formImageUrl && !imageError ? (
                  <div className="relative w-24 h-24 rounded-xl border border-slate-200 overflow-hidden shrink-0 bg-slate-100 group">
                    <img 
                      src={formImageUrl} 
                  ...
                  <div className="w-24 h-24 rounded-xl border-2 border-dashed border-slate-300 flex flex-col items-center justify-center text-slate-400 shrink-0 bg-white">
                ...
                <div className="flex-1 space-y-2 w-full">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-1.5 bg-white hover:bg-slate-100 border border-slate-200 text-slate-700 rounded-xl text-xs font-bold transition shadow-2xs cursor-pointer flex items-center gap-1.5"
                    >
                  ...
                  <p className="text-[10px] text-slate-500 leading-tight">
                    Ao utilizar este modelo no WhatsApp, a imagem será automaticamente anexada pronta para envio ao lead.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                <button
                  ...
                  className="px-2 py-0.5 bg-indigo-50 hover:bg-indigo-100 text-[#3742AC] border border-indigo-200 rounded-lg text-[11px] font-mono font-bold transition cursor-pointer"
                ...
                <button
                  ...
                  className="px-2 py-0.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 border border-emerald-200 rounded-lg text-[11px] font-mono font-bold transition cursor-pointer"
                ...
                <button
                  ...
                  className="px-2 py-0.5 bg-amber-50 hover:bg-amber-100 text-amber-800 border border-amber-200 rounded-lg text-[11px] font-mono font-bold transition cursor-pointer"
                ...
                <button
                  ...
                  className="px-2 py-0.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 rounded-lg text-[11px] font-mono font-bold transition cursor-pointer"
            ...
            <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
              ...
              <button
                type="submit"
                className="px-5 py-2 bg-[#3742AC] hover:bg-indigo-700 text-white rounded-xl text-xs font-extrabold transition shadow-md cursor-pointer flex items-center gap-1.5 active:scale-95"
              >
          ...
          <div className="space-y-4">
            ...
            {filteredTemplates.length === 0 ? (
              <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 space-y-3">
                ...
                <h4 className="text-sm font-bold text-slate-700">Nenhum modelo encontrado</h4>
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  {searchQuery
                    ? 'Tente utilizar outros termos na busca ou limpe o filtro de categoria.'
                    : 'Cadastre seu primeiro modelo de resposta rápida para acelerar o atendimento pelo WhatsApp!'}
                </p>
                <button
                  type="button"
                  onClick={handleStartCreate}
                  className="inline-flex items-center gap-1.5 bg-[#3742AC] text-white font-bold text-xs px-4 py-2 rounded-xl transition shadow-2xs hover:bg-indigo-700 cursor-pointer"
                >
                  <Plus className="w-4 h-4" />
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/60 backdrop-blur-2xs animate-fadeIn">
      <div className="w-full max-w-4xl h-[90vh] max-h-[820px] flex flex-col">
        {content}
      </div>
    </div>
  );
